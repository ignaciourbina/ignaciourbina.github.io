...
One URL per block. Paste it into that block's iframe/embed field — nothing else
goes in iPoster, and no text needs typing in its editor.
...
| Slot | Block | Link |
|---|---|---|
| Column 1, top | The puzzle | `https://ignaciourbina.github.io/poster/block-1.html` |
| Column 1, bottom | Theory and hypotheses | `https://ignaciourbina.github.io/poster/block-2.html` |
| Column 2, full height | Research design | `https://ignaciourbina.github.io/poster/block-3.html` |
| Column 3, full height | Results | `https://ignaciourbina.github.io/poster/block-4.html` |
| Column 4, top | Power, robustness, sensitivity | `https://ignaciourbina.github.io/poster/block-5.html` |
| Column 4, bottom | Takeaways and implications | `https://ignaciourbina.github.io/poster/block-6.html` |

Plain list, in the same order:

```
https://ignaciourbina.github.io/poster/block-1.html
https://ignaciourbina.github.io/poster/block-2.html
https://ignaciourbina.github.io/poster/block-3.html
https://ignaciourbina.github.io/poster/block-4.html
https://ignaciourbina.github.io/poster/block-5.html
https://ignaciourbina.github.io/poster/block-6.html
```

## If iPoster asks for the full tag instead of a URL
...
Set width and height to 100%. Never give a fixed pixel height: each page sizes
its own type to whatever box it lands in, and scrolls internally when the
content is longer than the block.
